...
DATASET='toy_pretrain' # dataset name
DATA_PATH="./dataset/${DATASET}/" # change DATA_PATH to the path where the data were stored

SPLIT_TYPE='split_1' # chosen from {'central', 'split_1', 'split_2', 'split_3'}
N_CLIENTS=6 # number of clients in the federated setting
MASK_RATIO=0.75 # masking ratio for ultrafedfm pre-training
